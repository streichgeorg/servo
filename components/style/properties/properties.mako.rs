...
pub mod style_structs {
    ...
    use media_queries::Device;
    use values::computed::NonNegativeLength;
    use style_traits::values::font::{SingleFontFamily, FontStretch, FontVariantCaps, FontWeight, FontStyle};
    ...
    % for style_struct in data.active_style_structs():
        ...
        % if style_struct.name == "Font":
            ...
            /// Implement `style_traits::values::font::FontStyle`, this way one can remove the
            /// gfx -> style dependency.
            impl FontStyle for Font {
                fn get_size(&self) -> Au {
                    self.font_size.size()
                }
